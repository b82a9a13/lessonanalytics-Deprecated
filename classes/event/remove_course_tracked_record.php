...
class remove_course_tracked_record extends base {
    ...
    public static function get_name(){
        return 'Record deleted in the course_tracked table';
    }
    public function get_description(){
        return "A record for the user with id '".$this->relateduserid."' has been deleted by user with id '".$this->userid."'.";
    }
